...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        mShowAddressBtn.setOnClickListener(ShowAddressBtnClickListener);

        initSpinnerCountries();
        initHouseNumbersSpinner();
    }

    Button.OnClickListener ShowAddressBtnClickListener = new View.OnClickListener() {
        @Override
